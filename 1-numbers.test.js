...
describe('typeof', function() { // describe - começa um bloco de teste....
  function typeOf(item) {
    // IMPLEMENTE
    return typeof item;
  }

  it('typeof integer', function() { // Cada it é uma parte que eu quero testar....
